...
const TeacherAddSubject = () => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md space-y-4">
            ...
            <input type="text" placeholder="Start Time (e.g. 9:00 AM)" value={startTime} onChange={(e) => setStartTime(e.target.value)} required className="w-full border rounded px-3 py-2" />
            <input type="text" placeholder="End Time (e.g. 10:30 AM)" value={endTime} onChange={(e) => setEndTime(e.target.value)} required className="w-full border rounded px-3 py-2" />
            ...
            <input type="text" placeholder="Theme Color (e.g. green)" value={themeColor} onChange={(e) => setThemeColor(e.target.value)} required className="w-full border rounded px-3 py-2" />
            
            <button type="submit" className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">Add Subject</button>
